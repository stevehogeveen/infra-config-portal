...
.PHONY: provider-lab-vcenter-install-apply
...
app-restart-lan: check-repo-root
...
provider-lab-hpe-firmware-inventory: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-hpe-firmware-inventory

provider-lab-ilo-firmware-inventory: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-ilo-firmware-inventory
...
provider-lab-hpe-firmware-upgrade-plan: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-hpe-firmware-upgrade-plan

provider-lab-hpe-firmware-upgrade-apply: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-hpe-firmware-upgrade-apply
...
provider-lab-golden-state: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-golden-state
...
provider-lab-vcenter-install-preview: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-vcenter-install-preview

provider-lab-vcenter-install-apply: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-vcenter-install-apply

provider-lab-vcenter-attach-esxi-preview: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-vcenter-attach-esxi-preview

provider-lab-vcenter-attach-esxi-apply: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-vcenter-attach-esxi-apply

provider-lab-vcenter-post-attach-validation: check-repo-root
	$(MAKE) -C $(REPO_ROOT)/app provider-lab-vcenter-post-attach-validation
