...
ALLOWED_WORKFLOW_ACTION_RUNNERS: dict[str, WorkflowActionExecutionSpec] = {
    ...
    "ilo.firmware-inventory": WorkflowActionExecutionSpec(
        ...
        registry_command="make provider-lab-hpe-firmware-inventory",
    ...
    "firmware.upgrade-plan": WorkflowActionExecutionSpec(
        ...
        registry_command="make provider-lab-hpe-firmware-upgrade-plan",
        reports=(
            "artifacts/codex-runs/hpe-firmware-upgrade-plan-report.md",
            "artifacts/codex-runs/hpe-firmware-upgrade-plan-redacted.json",
        ),
        timeout_seconds=45,
    ),
    "firmware.hpe-upgrade-apply": WorkflowActionExecutionSpec(
        action_id="firmware.hpe-upgrade-apply",
        kind="command",
        label="Run HPE Firmware Upgrade",
        command=("make", "provider-lab-hpe-firmware-upgrade-apply"),
        registry_command="make provider-lab-hpe-firmware-upgrade-apply",
        reports=(
            "artifacts/codex-runs/hpe-firmware-upgrade-apply-report.md",
            "artifacts/codex-runs/hpe-firmware-upgrade-apply-redacted.json",
            "artifacts/codex-runs/hpe-firmware-upgrade-plan-report.md",
            "artifacts/codex-runs/hpe-firmware-upgrade-plan-redacted.json",
        ),
        timeout_seconds=180,
