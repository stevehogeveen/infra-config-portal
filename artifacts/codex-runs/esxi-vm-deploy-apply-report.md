# ESXi VM Deploy Vm Deploy Apply Report

- Checked at: `2026-06-11T02:34:36.695884+00:00`
- Status: `blocked`
- Apply enabled: `False`
...
- VM_DEPLOY_APPLY=true is required.
- VM_DEPLOY_CONFIRM="DEPLOY ESXI OVF VM" is required.
- VM_DEPLOY_ALLOW_CREATE=true is required.
