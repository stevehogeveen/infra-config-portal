...
Checked at: 2026-06-09T22:26:02.225527+00:00
...
## Candidate Summary
- `/dev/serial/by-id/usb-Microchip_Technology_Inc._MCP2221_USB-I2C_UART_Combo-if00` | type=`by-id` | exists=`True` | rw=`True/True` | in_use=`False` | mtime=`2026-06-09T20:56:20.595289+00:00` | rank=`-35` | confidence=`high` | reason=stable /dev/serial/by-id path; candidate name matches NetApp serial hint
- `/dev/ttyACM0` | type=`ttyACM` | exists=`True` | rw=`True/True` | in_use=`False` | mtime=`2026-06-09T20:56:20.595289+00:00` | rank=`65` | confidence=`medium` | reason=ttyACM USB serial fallback; candidate name matches NetApp serial hint
